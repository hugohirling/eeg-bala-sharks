...
def _handle_events_reading_core(events_fname, raw):
    ...
    # Worst case, we go with 'n/a' for all events
        ...
        # falls kein trial_type oder value vorhanden, erstelle Array der Länge onsets
        descriptions = np.array(['n/a'] * len(events_dict['onset']))
    ...
    descriptions = np.array(descriptions)[good_events_idx]
    del good_events_idx
